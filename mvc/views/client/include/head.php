...
<head>
    ...
    <meta name="viewport" content="wiinfoh=device-wiinfoh, initial-scale=1.0">
    ...
    <!-- <link rel="stylesheet" href="public/client/assets/css/base.css"> -->
    <!-- <link rel="stylesheet" href="public/client/assets/css/main.css"> -->
    <!-- <link rel="stylesheet" href="public/client/assets/css/main_triet.css">
    ...
    <style>
    <?php 
    include "public/client/assets/css/base.css" ;
    include "public/client/assets/css/main.css";
    include "public/client/assets/css/main_triet.css";
    include "public/client/assets/css/responsive_triet.css";
    include "public/client/assets/css/css1.css";
