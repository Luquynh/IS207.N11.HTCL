                    ...
                    <form action="" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    <select name="data[makichthuoc]"  style="width: 60px;" class="form-control">
                                       ...
                                       <option value="<?=$arr_id[3]?>"><?=$arr_ten[3]?></option>
                                       <option value="<?=$arr_id[4]?>"><?=$arr_ten[4]?></option>
                                       <option value="<?=$arr_id[5]?>"><?=$arr_ten[5]?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <textarea  class="form-control" rows="4" value="" name="data[mota]"></textarea>
